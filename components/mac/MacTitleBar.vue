...
<template>
	<div class="title-bar h-[30px] glass px-2" ref="titleBar">
		<div class="flex items-center h-full pl-[70px]">
			<!-- logo -->
			<!-- <div class="flex items-center justify-center w-[18px] h-[18px] mr-1" v-if="useStore().theme == 'dark'">
