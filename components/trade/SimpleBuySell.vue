<script setup lang="ts">
	...
	const side = ref<Sides>(Sides.SELL)
...
<template>
	<div class="simple-buysell">
		...
		<TradeOrder :symbol="symbol" @close="onClose" :price="price" :isH5="true" :openLarverage="openLarverage" :side="side" @update:side="(val: Sides) => side = val" :hideProfitLoss="true" />
	</div>
</template>
