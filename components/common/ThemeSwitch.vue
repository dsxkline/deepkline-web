<script setup lang="ts">
	...
	onMounted(() => {
		colorCookie = useSyncedCookie('nuxt-color-mode', { default: () => 'dark' })
		theme.value = 'dark' !== colorCookie.value
	})
</script>
<template>
	<el-switch v-model="theme" width="30" :active-action-icon="ElIconSunny" :inactive-action-icon="ElIconMoon" v-click-sound @change="changeTheme" />
</template>
