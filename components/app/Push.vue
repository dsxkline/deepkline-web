<script setup lang="ts">
	...
	const closed = () => {
		console.log('drawer 调用 closed',drawer.value)
		//show.value = false
...
<template>
	<div class="drawer-container" ref="drawerContainer" v-if="show">
		...
		>
			<template #default>
				<div class="drawer_body w-full h-full flex flex-col relative" v-swipe-down="direction == 'btt' && size != '100%' ? swipeDown : null" v-if="visibleDrawer">
