...
export default {
	...
	createDarkTheme(config: DsxConfig) {
		createTheme(config, 'dark', {
			...
			fontSize: 10, // 字体大小
			redColor: useKlineStore().klineColorModel == 'green-red' ? 'rgb(245 70 130)' : 'rgb(45 189 133)',
			greenColor: useKlineStore().klineColorModel == 'green-red' ? 'rgb(45 189 133)' : 'rgb(245 70 130)',
			rectRedColor: useKlineStore().klineColorModel == 'green-red' ? 'rgb(245 70 130)':'rgb(45 189 133)', // 矩形红色 一般用作成交量
			rectGreenColor: useKlineStore().klineColorModel == 'green-red' ? 'rgb(45 189 133)':'rgb(245 70 130)', // 矩形绿色
			crossLineColor: 'rgba(255, 255, 255, 0.4)', // 十字线颜色
			crossLineWidth: 1, // 十字线宽度
			crossBorderColor: '#c5cbce', // 十字线边框颜色
			crossFontColor: '#fff',
			crossBgColor: 'rgba(13,16,23, 1.0)',
			crossDash: [10, 5], // 虚线配置 例如 [5,5] 每隔五像素空五像素，达到虚线效果
			crossFontSize: 12,
			crossButtonHeight: 12 + 6,
			crossLineMarginRight: 0, // 十字线提示器离右边的距离
			fontBgColor: 'rgba(13,16,23, 1.0)', // 文字背景颜色
			fontWeight: '', // bold
			gridLineColor: 'rgba(61,67,82,0.3)', // 网格线颜色
			gridLineCount: 10, // 网格线数量
			gridLineWidth: 1, // 网格线的宽度
			lineWidth: 1.0, // 线条
			klineWidth: 7, // 一根k线的默认宽度
			...
			realTimeLineColor: 'rgba(255,255,255,0.5)',
			realTimeBgColor: 'rgba(13,16,23, 1.0)',
	...
	createWhiteTheme(config: DsxConfig) {
		createTheme(config, 'white', {
			...
			crossDash: [15, 5], // 虚线配置 例如 [5,5] 每隔五像素空五像素，达到虚线效果
			crossFontSize: 12,
			crossButtonHeight: 12 + 6,
			crossLineMarginRight: 0, // 十字线提示器离右边的距离
