...
export const tradingDataFetch = {
     ...
     * @returns 
     */
    loanRatio:<T = any> (ccy: string, period: Period = Period.M5, begin?: string, end?: string) => useGet<ApiResult<T>>(baseUrl, apiLoanRatio, {
        ccy,
        begin,
        end,
        period
     ...
     * @returns 
     */
    openInterestVolume: <T = any>(ccy: string, period: Period = Period.M5, begin?: string, end?: string) => useGet<ApiResult<T>>(baseUrl, apiOpenInterestVolume, {
        ccy,
        begin,
        end,
        period
     ...
     * @returns 
     */
    takerVolume: <T = any>(ccy: string,instType:InstanceType, period: Period = Period.M5, begin?: string, end?: string) => useGet<ApiResult<T>>(baseUrl, apiTakerVolume, {
        ccy,
        instType,
        begin,
        end,
